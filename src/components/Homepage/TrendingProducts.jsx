...
export const TrendingProducts = () => {
  ...
  return (
    <section className="py-10 lg:py-20" id="products">
      ...
      <section className="px-4 mt-12 lg:mt-16 max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[repeat(auto-fit,_33.666666%)] gap-5 justify-center">
        {data?.map((item) => (
